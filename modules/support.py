...
icon = "https://i.hizliresim.com/PQzLW2.jpg" \
       "readme/star.png"
class_name = "Support"
...
class Support(Module):
    ...
    def get_social_channels(self, msg, client):
        channels = []
        channels.append({"act": True, "prt": 1, "id": 1, "stid": "Discord",
                         "dsctn": f"DİSCORD ADRESİMİZE GELEREK BİRÇOK FIRSATA SAHİP OLABİLİRSİNİZ ;(\n"
                         f"DİSCORD: {self.server.revision}",
                         "ttl": "Discord", "icnurl": icon,
                         "lnk": "https://discord.gg/aWBk5JJ"})
