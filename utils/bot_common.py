...
def new_account(redis):
    ...
    pipe.set(f"uid:{uid}:slvr", 100000000000)
    pipe.set(f"uid:{uid}:gld", 1000000000000)
    pipe.set(f"uid:{uid}:enrg", 100000)
    pipe.set(f"uid:{uid}:exp", 50000000000)
...
def reset_account(redis, uid):
    ...
    pipe.delete(f"uid:{uid}:crt", 350000)
    pipe.delete(f"uid:{uid}:hrt", 9999999999)
